...
def set_up_sample_3d_cubic_test():
...
def test_sample_3d_benchmark(benchmark):
    benchmark(set_up_sample_3d_cubic_test)
...
class TestSample3DCubic(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        particle_data, split = set_up_sample_3d_cubic_test()
        
        cls.particle_data = particle_data
        cls.split = split
        

    def test_sample_3d_cubic_name(self):
        """Test column name in particle data."""

        assert self.split.name == "sample_test"


    def test_sample_3d_cubic_ParticleAttribute(self):
    ...
    def test_sample_3d_cubic_cells(self):
    ...
    def test_sample_3d_cubic_occupied_cells(self):
    ...
    def test_sample_3d_cubic_particles(self):
    ...
    def test_sample_3d_cubic_sample_ids(self):
    ...
    def test_sample_3d_cubic_vector_1_bounds(self):
    ...
    def test_sample_3d_cubic_vector_2_centers(self):
    ...
    def test_sample_3d_cubic_vector_2_bounds(self):
    ...
    def test_sample_3d_cubic_vector_3_centers(self):
    ...
    def test_sample_3d_cubic_vector_3_bounds(self):
