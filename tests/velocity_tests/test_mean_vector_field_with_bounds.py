...
def test_mean_velocity_vector_field_1():
...
def test_mean_velocity_vector_field_1_benchmark(benchmark):
    benchmark(test_mean_velocity_vector_field_1)


def test_mean_velocity_vector_field_2():
...
def test_mean_velocity_vector_field_2_benchmark(benchmark):
    benchmark(test_mean_velocity_vector_field_2)