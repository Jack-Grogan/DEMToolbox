...
def set_up_lacey_mixing_index_polydisperse_test():
...
def test_lacey_mixing_index_polydisperse_benchmark(benchmark):
    benchmark(set_up_lacey_mixing_index_polydisperse_test)
...
class TestLaceyMixingIndex(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        result = set_up_lacey_mixing_index_polydisperse_test()
