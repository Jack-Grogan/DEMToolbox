...
from DEMToolbox.particle_sampling import sample_1d_volume, sample_3d
...
def set_up_lacey_mixing_index_part_mixed_test():
    ...
    cylinder_data = create_cylinder(
        radius=0.03, height=0.16, resolution=100)
...
class TestLaceyMixingIndex(unittest.TestCase):
    ...
    def test_lacey_mixing_index_part_mixed(self):
        ...
        # 6x6x30 points 360 of each type across the 3 occupied samples, 
        # 1080 points in total
        mixed_variance = unmixed_variance / (1080/3)
